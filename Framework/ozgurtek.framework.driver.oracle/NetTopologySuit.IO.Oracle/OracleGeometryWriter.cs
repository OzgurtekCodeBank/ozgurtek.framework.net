...
namespace ozgurtek.framework.driver.oracle.NetTopologySuit.IO.Oracle
{
    /// <summary>
    ...
    public class OracleGeometryWriter
    {
        ...
        private int ProcessPolygon(Polygon polygon, List<decimal> elemInfoList, List<decimal> ordinateList, int pos)
        {
            ...
            pos += NetTopologySuite.Algorithm.Orientation.IsCCW(exteriorRingCoords)
            ...
            for (int i = 0; i < interiorRingCount; i++)
            {
                ...
                pos += NetTopologySuite.Algorithm.Orientation.IsCCW(interiorRingCoords)
